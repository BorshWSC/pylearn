<?php 
	...
	$query = "SELECT * FROM notification WHERE user_recipient_id = '$id' AND valid = 0 AND chosen = 0;"; 
...
<div class="tabcontent-message tabcontent-message-active" id="new-message">
		...
		<div class="message" id="<?= $message_id ?>">
			<div class="message__fonts">
				<i class="far fa-sticky-note" id="read"></i>
				<i class="far fa-bookmark" id="chosen"></i>
