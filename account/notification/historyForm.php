<?php 
	...
	$query = "SELECT * FROM notification WHERE user_recipient_id = '$id' AND chosen = 0 AND valid = 1;"; 
...
<div class="tabcontent-message" id="history">
		...
		<div class="message" id="<?= $message_id ?>">
			<div class="message__fonts">
				<i class="far fa-sticky-note active-icon" id="read"></i>
